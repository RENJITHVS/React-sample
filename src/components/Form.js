...
function Form({getData}) {
    ...
    <div className="col-xl-6 col-lg-7 col-md-9">
      <form onSubmit={calculate} className='border p-4 shadow bg-body rounded'>
        ...
        <div className="row mb-3 ">
          ...
          <div className="col-sm-10">
            <input type="text" value={weight} onChange={(e)=> setWeight(e.target.value)} className="form-control" id="weightid" required/>
          </div>
        </div>
        <div className="row mb-3">
          <label  className="col-sm-2 col-form-label">
          ...
          <div className="col-sm-10 ">
            <input type="text" value={height} onChange={(e)=> setHeight(e.target.value)}  className="form-control" id="heightid" required/>
          </div>
        </div>
      ...
      { alert && <div className="alert alert-danger"> please enter the valid data</div> }
    </div>
  );
}
